...
export default function OnboardingScreen() {
  ...
  return (
    <SafeAreaView className="flex-1">
      <View className="flex h-full w-full flex-col items-center bg-background bg-white p-8 pb-8">
        <View className="flex flex-col items-center">
          ...
          <Text className="text-center text-xl font-medium">
            A cada ação, você ganha pontos que podem ser trocados por
            recompensas. Mas o maior prêmio é contribuir para um planeta mais
            verde e saudável.
          </Text>
